...
const VIEW_PERMISSIONS: ModulePermission[] = [
  { code: "view", label: "Ver", description: "Permite consultar registros." },
];

const LOCATION_PERMISSIONS: ModulePermission[] = [
  ...CRUD_PERMISSIONS,
  { code: "view_all_locations", label: "Ver todas las sedes", description: "Permite desactivar el filtro por sede y consultar documentos de todas las sedes." },
];
...
export const SYSTEM_MODULES_CATALOG: ModuleRecord[] = [
  ...
  withPermissions(
    ...
    [
      ...
      { order: 17, name: "saleOrderCode", header: "Orden de Venta", filter: true },
    ],
    INVOICE_PERMISSIONS
  ),
  ...
  withPermissions("supplier", "Proveedores", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "businessName", header: "Razón social", filter: true },
    { order: 3, name: "commercialName", header: "Nombre comercial", filter: true },
    { order: 4, name: "documentNumber", header: "Nº documento", filter: true },
    { order: 5, name: "contactName", header: "Contacto", filter: true },
    { order: 6, name: "paymentCondition", header: "Cond. pago", filter: true },
    { order: 7, name: "status", header: "Estado", filter: true, format: "status" },
  ]),
  ...
  withPermissions("product-attribute-type", "Tipos de atributo", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "label", header: "Etiqueta", filter: true },
    { order: 3, name: "flagsDisplay", header: "Uso", filter: true },
    { order: 4, name: "valuesDisplay", header: "Valores", filter: true },
    { order: 5, name: "sortOrder", header: "Orden", filter: true },
    { order: 6, name: "active", header: "Activo", filter: true, format: "bool" },
  ]),
  withPermissions("product", "Productos", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "name", header: "Nombre", filter: true },
    { order: 3, name: "categoryName", header: "Categoría", filter: true },
    { order: 4, name: "type", header: "Tipo", filter: true, format: "label" },
    { order: 5, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
  ...
  withPermissions("purchase-order", "Órdenes de compra", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "supplierName", header: "Proveedor", filter: true },
    { order: 3, name: "issueDate", header: "F. Emisión", filter: true },
    { order: 4, name: "currency", header: "Moneda", filter: true },
    { order: 5, name: "total", header: "Total", filter: true },
    { order: 6, name: "status", header: "Estado", filter: true, format: "label" },
    { order: 7, name: "locationName", header: "Sede", filter: true },
    { order: 8, name: "purchaseOrderItems", header: "Ítems", filter: false },
  ]),
  withPermissions("purchase-order-item", "Ítems de orden de compra", [
    { order: 1, name: "productName", header: "Producto", filter: true },
    { order: 2, name: "quantity", header: "Cantidad", filter: true },
    { order: 3, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
    { order: 4, name: "unitPrice", header: "P. Unitario", filter: true },
    { order: 5, name: "subtotal", header: "Subtotal", filter: true },
    { order: 6, name: "taxAmount", header: "Impuesto", filter: true },
    { order: 7, name: "total", header: "Total", filter: true },
  ]),
  withPermissions("quotation", "Cotizaciones", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "clientName", header: "Cliente", filter: true },
    { order: 3, name: "issueDate", header: "F. Emisión", filter: true },
    { order: 4, name: "validUntil", header: "Válido hasta", filter: true },
    { order: 5, name: "currency", header: "Moneda", filter: true },
    { order: 6, name: "total", header: "Total", filter: true },
    { order: 7, name: "status", header: "Estado", filter: true, format: "label" },
    { order: 8, name: "locationName", header: "Sede", filter: true },
    { order: 9, name: "quotationItems", header: "Ítems", filter: false },
    { order: 10, name: "saleOrder", header: "OV generada", filter: false },
  ]),
  withPermissions("quotation-item", "Ítems de cotización", [
    { order: 1, name: "productCode", header: "Código", filter: true },
    { order: 2, name: "productName", header: "Producto", filter: true },
    { order: 3, name: "quantity", header: "Cantidad", filter: true },
    { order: 4, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
    { order: 5, name: "unitPrice", header: "P. Unitario", filter: true },
    { order: 6, name: "discount", header: "Descuento", filter: true },
    { order: 7, name: "subtotal", header: "Subtotal", filter: true },
    { order: 8, name: "total", header: "Total", filter: true },
  ]),
  withPermissions("sale-order", "Órdenes de venta", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "clientName", header: "Cliente", filter: true },
    { order: 3, name: "issueDate", header: "F. Emisión", filter: true },
    { order: 4, name: "currency", header: "Moneda", filter: true },
    ...
    { order: 6, name: "status", header: "Estado", filter: true, format: "label" },
    { order: 7, name: "locationName", header: "Sede", filter: true },
    { order: 8, name: "saleOrderItems", header: "Ítems", filter: false },
  ]),
  withPermissions("sale-order-item", "Ítems de orden de venta", [
    { order: 1, name: "productCode", header: "Código", filter: true },
    { order: 2, name: "productName", header: "Producto", filter: true },
    { order: 3, name: "quantity", header: "Cantidad", filter: true },
    { order: 4, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
  ...
  withPermissions("inventory-movement", "Movimientos de inventario", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "type", header: "Tipo", filter: true },
    { order: 3, name: "warehouseName", header: "Almacén", filter: true },
    { order: 4, name: "productName", header: "Producto", filter: true },
    { order: 5, name: "quantity", header: "Cantidad", filter: true },
    { order: 6, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
    { order: 7, name: "referenceType", header: "Tipo referencia", filter: true },
    { order: 8, name: "date", header: "Fecha", filter: true },
    { order: 9, name: "locationName", header: "Sede", filter: true },
  ]),
  withPermissions("inventory-kardex", "Kardex", [
    { order: 1, name: "date", header: "Fecha", filter: true },
    { order: 2, name: "type", header: "Tipo", filter: true },
    { order: 3, name: "quantityIn", header: "Entrada", filter: true },
    { order: 4, name: "quantityOut", header: "Salida", filter: true },
    { order: 5, name: "balanceAfter", header: "Saldo", filter: true },
    { order: 6, name: "unitCostApplied", header: "Costo unit.", filter: true },
    { order: 7, name: "averageUnitCostAfter", header: "Costo prom.", filter: true },
    { order: 8, name: "balanceValueAfter", header: "Valor saldo", filter: true },
    { order: 9, name: "referenceId", header: "Referencia", filter: true },
  ], VIEW_PERMISSIONS),
  withPermissions("stock-level", "Stock", [
    { order: 1, name: "productName", header: "Producto", filter: true },
    { order: 2, name: "variantSku", header: "SKU variante", filter: true },
    { order: 3, name: "warehouseName", header: "Almacén", filter: true },
    { order: 4, name: "quantity", header: "Cantidad", filter: true },
    { order: 5, name: "averageUnitCost", header: "Costo prom.", filter: true },
    { order: 6, name: "inventoryValue", header: "Valor inventario", filter: true },
    { order: 7, name: "currencyCode", header: "Moneda", filter: true },
    { order: 8, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
    { order: 9, name: "lastMovementDate", header: "Último movimiento", filter: true },
  ], VIEW_PERMISSIONS),
  withPermissions(
    "sunat-config",
    "Configuración SUNAT",
  ...
  withPermissions("recipe", "Recetas", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "name", header: "Nombre", filter: true },
    { order: 3, name: "status", header: "Estado", filter: true, format: "status" },
    { order: 4, name: "version", header: "Versión", filter: true },
    { order: 5, name: "baseQuantity", header: "Cantidad base", filter: true },
    { order: 6, name: "baseUnitOfMeasureName", header: "Unidad base", filter: true },
    { order: 7, name: "recipeMaterials", header: "Materiales", filter: false },
    { order: 8, name: "recipeResults", header: "Productos", filter: false },
  ]),
  withPermissions("recipe-material", "Materiales de receta", [
    { order: 1, name: "productCode", header: "Código", filter: true },
    { order: 2, name: "productName", header: "Producto", filter: true },
    { order: 3, name: "quantity", header: "Cantidad", filter: true },
    { order: 4, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
  ]),
  withPermissions("recipe-result", "Resultados de receta", [
    { order: 1, name: "type", header: "Tipo", filter: true, format: "label" },
    { order: 2, name: "productCode", header: "Código", filter: true },
    { order: 3, name: "productName", header: "Producto", filter: true },
    { order: 4, name: "quantity", header: "Cantidad", filter: true },
    { order: 5, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
  ]),
  withPermissions("production-order", "Órdenes de producción", [
    { order: 1, name: "code", header: "Código", filter: true },
    { order: 2, name: "finishedProductName", header: "Producto terminado", filter: true },
    { order: 3, name: "status", header: "Estado", filter: true, format: "status" },
    { order: 4, name: "priority", header: "Prioridad", filter: true, format: "label" },
    { order: 5, name: "quantityToProduce", header: "Cantidad a producir", filter: true },
    { order: 6, name: "recipeName", header: "Receta", filter: true },
    { order: 7, name: "plannedStartDate", header: "Inicio planificado", filter: true, format: "date" },
    { order: 8, name: "plannedEndDate", header: "Fin planificado", filter: true, format: "date" },
    { order: 9, name: "totalCost", header: "Costo total", filter: true },
    { order: 10, name: "unitCost", header: "Costo unitario", filter: true },
    { order: 11, name: "orderMaterials", header: "Materiales", filter: false },
    { order: 12, name: "orderResults", header: "Resultados", filter: false },
    { order: 13, name: "orderCosts", header: "Costos", filter: false },
  ]),
  withPermissions("order-material", "Materiales de orden", [
    { order: 1, name: "productCode", header: "Código", filter: true },
    { order: 2, name: "productName", header: "Producto", filter: true },
    { order: 3, name: "requiredQuantity", header: "Cantidad requerida", filter: true },
    { order: 4, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
  ]),
  withPermissions("order-result", "Resultados de orden", [
    { order: 1, name: "type", header: "Tipo", filter: true, format: "label" },
    { order: 2, name: "productCode", header: "Código", filter: true },
    { order: 3, name: "productName", header: "Producto", filter: true },
    { order: 4, name: "plannedQuantity", header: "Cant. planificada", filter: true },
    { order: 5, name: "actualQuantity", header: "Cant. real", filter: true },
    { order: 6, name: "unitOfMeasureAbbreviation", header: "Unidad", filter: true },
  ]),
  withPermissions("production-cost", "Costos de producción", [
    { order: 1, name: "type", header: "Tipo", filter: true, format: "label" },
    { order: 2, name: "concept", header: "Concepto", filter: true },
    { order: 3, name: "hours", header: "Horas", filter: true },
    { order: 4, name: "hourlyRate", header: "Tarifa", filter: true },
    { order: 5, name: "amount", header: "Monto", filter: true },
  ]),
];
